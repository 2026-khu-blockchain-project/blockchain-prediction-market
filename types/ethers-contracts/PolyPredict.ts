...
decodeFunctionResult(functionFragment: 'usdc', data: BytesLike): Result;
    ...
    export namespace MarketCreatedEvent {
      export type InputTuple = [marketId: BigNumberish, question: string, category: string, deadline: BigNumberish];
      export type OutputTuple = [marketId: bigint, question: string, category: string, deadline: bigint];
      export interface OutputObject {marketId: bigint, question: string, category: string, deadline: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace SharesBurnedEvent {
      export type InputTuple = [marketId: BigNumberish, burner: AddressLike, amount: BigNumberish];
      export type OutputTuple = [marketId: bigint, burner: string, amount: bigint];
      export interface OutputObject {marketId: bigint, burner: string, amount: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    createMarket: TypedContractMethod<
      [_question: string, _description: string, _category: string, _outcomeYes: string, _outcomeNo: string, _deadline: BigNumberish, ],
      [bigint],
      'nonpayable'
    >
...
getEvent(key: 'WinningsClaimed'): TypedContractEvent<WinningsClaimedEvent.InputTuple, WinningsClaimedEvent.OutputTuple, WinningsClaimedEvent.OutputObject>;
    ...
    filters: {
      ...
      'SharesBurned(uint256,address,uint256)': TypedContractEvent<SharesBurnedEvent.InputTuple, SharesBurnedEvent.OutputTuple, SharesBurnedEvent.OutputObject>;
